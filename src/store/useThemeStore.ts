...
export const THEMES: Theme[] = [
  ...
  },
  {
    ...
    name: 'Sci-Fi',
    icon: '🚀',
    description: 'Tactical console with signal-green accents',
    colors: {
      background: '#071522',
      paper: '#0d2d43',
      ink: '#e1f4ff',
    ...
    buttonRadius: '3px',
    borderWidth: '1px',
    shadowStyle: '2px 2px 0 var(--color-border), 0 8px 18px var(--color-shadow)',
  ...
  },
  {
    ...
    buttonRadius: '8px',
    borderWidth: '2px',
    shadowStyle: '0 0 6px var(--color-glow), 0 0 12px var(--color-shadow)',
    cardTexture: 'arcs',
    textureOpacity: 0.15,
    borderStyle: 'solid',
  },
  ...
  },
  {
    ...
    fonts: {
      ...
      body: '"Consolas", "Lucida Console", monospace',
    },
    borderRadius: '3px',
    buttonRadius: '3px',
    borderWidth: '1px',
    shadowStyle: '0 2px 0 var(--color-shadow), 0 8px 18px var(--color-shadow)',
    cardTexture: 'metal',
    textureOpacity: 0.1,
    borderStyle: 'solid',
  },
